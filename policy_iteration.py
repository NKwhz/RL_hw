...
class Agent:
    def __init__(self, k, n):
        '''
        k is the number of training iterations for one policy
        n is the max number of policy generations
        '''
        ...
        for i in range(self.n):
            ...
            for j in range(self.k):
                ...
                for s in range(state_size):
                    ...
                    #     print(r)
                    s_ = next_state(s, a)
                    temp[s] += r + self.gamma * self.state_reward[s_]
            ...
            for s in range(self.state_policy.shape[0]):
                ...
                for a in range(len(self.actions)):
                    ...
                    v_s = self.state_reward[s_] * self.gamma + self.rewarding(s_)
                    if v_s > max_v:
                        max_v = v_s
                        max_a = a
                for a in range(len(self.actions)):
